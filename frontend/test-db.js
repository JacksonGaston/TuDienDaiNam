...
async function testDatabase() {
  ...
  try {
    ...
    console.log('3. Testing search functionality (searchWord)...');
    ...
    console.log('4. Testing suggestions (getSuggestions)...');
    ...
    console.log('5. Testing random words...');
    ...
    if (searchResults.match) {
      console.log('6. Testing get word by ID...');
    ...
    console.log('7. Testing get word by word...');
